...
- [x] **One-Click Launchers:**
  - [x] `run.bat` for Windows (venv bootstrap + browser auto-launch).
  - [x] `run.sh` for macOS / Linux (venv bootstrap + browser auto-launch).
  - [x] Support fast path via `uv` if present on host.
- [ ] **Release Bundling:**
